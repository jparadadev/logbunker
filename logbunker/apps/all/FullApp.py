...
from logbunker.apps.bunker.routes import register_routes as register_bunker_routes
from logbunker.apps.backoffice.backend.routes import register_routes as register_backoffice_routes
